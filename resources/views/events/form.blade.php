                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-select" name="event_type_id" id="event_type_id" value="{{is_null(old('event_type_id')) ? $event->event_type_id : old('event_type_id')}}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="sector_id" id="sector_id" value="{{is_null(old('sector_id')) ? $event->sector_id : old('sector_id')}}">
                                <option value=""></option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="duty_user_id" id="duty_user_id" value="{{is_null(old('duty_user_id')) ? $event->duty_user_id : old('duty_user_id')}}">
                                <option value="">SELECIONE</option>
