                    ...
                    <div class="modal-content">
                        <form class="form" action="{{ route('certificate-types.destroy', ['id' => $certificateType->id]) }}" method="post">
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-success btn-sm text-white close-modal" id="submitRemoverTipoPorte" title="Remover Tipo de Porte"><i class="fa fa-check"></i> Remover</button>
