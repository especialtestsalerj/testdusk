    ...
    <div x-init=""
     ...
     ">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <livewire:contacts.form :contacts="$this->contact" :person_id="$this->person_id" :modal="$this->modal" :readonly="false" :is-visitors-form="true" :has-mask="$this->detectIfCountryBrSelected()"/>
            </div>
