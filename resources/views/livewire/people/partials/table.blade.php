                                            ...
                                            <div class="col-7 d-flex flex-column pt-2 visitor-data">
                                                ...
                                                <div class="row card-buttons mt-auto d-flex">
                                                    <div class="d-flex justify-content-center">
                                                        @if ($guest->hasPendingVisitors())
                                                            <div class="col-3 d-flex justify-content-end">
                                                    <span class="btn btn-link px-2 py-1" wire:click="generateBadge({{ $guest->pendingVisit->id }})" title="Imprimir Etiqueta">
                                                        <i class="fa fa-lg fa-print"></i>
                                                    </span>
                                                            </div>
                                                        @endif
                                                        @can('people:show')
                                                            <div class="col-3 d-flex justify-content-end">
                                                                <a href="{{ route('people.form', ['id' => $guest->id, 'redirect' => $redirect, 'disabled' => true]) }}" class="btn btn-link px-2 py-1" title="Detalhar">
                                                                    <i class="fa fa-lg fa-search"></i>
                                                                </a>
                                                            </div>
                                                        @endCan
                                                        @can('people:update')
                                                            <div class="col-3 d-flex justify-content-end">
                                                                <a href="{{ route('people.form', ['id' => $guest->id, 'redirect' => $redirect, 'disabled' => false]) }}" class="btn btn-link px-2 py-1" title="Alterar">
                                                                    <i class="fa fa-lg fa-pencil"></i>
                                                                </a>
                                                            </div>
                                                        @endCan
