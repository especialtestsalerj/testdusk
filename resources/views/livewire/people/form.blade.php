                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select class="form-control text-uppercase" name="has_disability" id="has_disability" wire:model="has_disability" x-ref="has_disability" @disabled(request()->query('disabled'))>
                                <option {{ is_null($person->has_disability) ? ' selected' : '' }} value="">SELECIONE</option>
                                <option {{ $person->has_disability ? ' selected' : '' }} value="true">SIM</option>
                                <option {{ !is_null($person->has_disability) && !$person->has_disability ? ' selected' : '' }} value="false">NÃO</option>
                            </select>
                        </div>
                    </div>
                </div>
