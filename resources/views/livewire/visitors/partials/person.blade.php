    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <select class="form-select" name="visitor_id" id="visitor_id" wire:model.defer="visitor_id" wire:change="find" @disabled(!$routineStatus)>
    ...
    <div class="row" id="dados-visitante">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="form-select" name="certificate_type" id="certificate_type" wire:model.defer="certificate_type" @disabled(!$routineStatus)>
                    <option value="">SELECIONE</option>
