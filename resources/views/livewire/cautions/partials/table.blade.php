                    ...
                    <div class="card-body py-1">
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-12 col-lg-4 text-center text-lg-end">
                                ...
                                <a href="{{ route('cautions.show', ['routine_id' => $routine_id, 'id' => $caution->id, 'redirect' => $redirect, 'disabled' => true]) }}" class="btn btn-link" title="Detalhar"><i class="fa fa-lg fa-search"></i></a>
                                @if($routine->status)
                                    <a href="{{ route('cautions.show', ['routine_id' => $routine_id, 'id' => $caution->id, 'redirect' => $redirect]) }}" class="btn btn-link" title="Alterar"><i class="fa fa-lg fa-pencil"></i></a>
                                    @if(!$caution->hasPending())
