...
@section('content')
        ...
        <section
            class="bg-center h-screen bg-no-repeat" style="background-image: url('{{ asset('img/fundo_alerj.jpg') }}');">
                ...
                <div class="w-10/12 2xl:w-3/4 mx-auto sm:mx-auto my-4 sm:my-0 ">
                    <div class="flex flex-col sm:flex-row gap-x-8">
                        ...
                        <div class="w-full lg:w-1/2">
                            <div
                                class="relative p-5 bg-white rounded-lg shadow mt-4 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:shadow-xl duration-300">
                                        ...
                                        <form method="get" action="{{route('agendamento.form')}}">
                                            ...
                                            <div class="mt-6">
                                                ...
                                                <select name="building_id" id="building_id"
                                                        class="px-4 py-3 w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm opacity-80"
                                            ...
                                            <div class="mt-6 md:mt-8">
                                                <button
                                                    class="w-full md:w-auto text-sm bg-brand-800 hover:bg-brand-950 px-4 py-2 text-white rounded-3xl font-medium">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <div class="mt-6">
                                                <input type="text" id="documentNumber"
                                                       class="px-4 py-3 w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm opacity-80"
                                                       name="documentNumber" placeholder="Documento">
                                            </div>
                                            <div class="mt-6 md:mt-8">
                                                <button
                                                    class="w-full md:w-auto text-sm bg-brand-800 hover:bg-brand-950 px-4 py-2 text-white rounded-3xl font-medium g-recaptcha"
