                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" max="3000-01-01T23:59" class="form-control text-uppercase" name="entranced_at" id="entranced_at" value="{{is_null(old('entranced_at')) ? $visitor->entranced_at_formatted: old('entranced_at')}}"/>
                        </div>
                        <div class="form-group">
