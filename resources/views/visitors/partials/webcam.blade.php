...
<div class="pb-2 text-right">
     <button type="button" class="btn btn-primary pb-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
         Tirar foto
     </button>
</div>

 <!-- Modal -->
 <div wire:ignore.self class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="staticBackdrop"
         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <div style="height: 100%">
                     ...
                     <button wire:click.prevent="removeWebcamFile" type="button"
                         style="border: none;
        padding: 0;
        background: none;"><i
