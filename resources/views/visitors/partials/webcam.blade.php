 ...
 <div class="pb-2 text-right">
     <button type="button" class="btn btn-primary pb-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
         Tirar foto
     </button>
 </div>
         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <div style="height: 100%">
                     ...
                     <button type="button" data-bs-dismiss="modal" wire:click="takeSnapshot" onclick="take_snapshot()"
                         style="border: none;
                        padding: 0;
                        background: none;"><i
                             class="fa-solid fa-camera"></i></button>
                     <label data-bs-dismiss="modal" for="webcam_file" style="cursor:pointer;">
                         <i class="fas fa-upload"></i>
                     </label>
                     <button data-bs-dismiss="modal" wire:click.prevent="removeWebcamFile" type="button"
                         style="border: none;
        padding: 0;
        background: none;"><i
     ...
     <div class="row control-group" transition="expand" data-instance="{{ $iteration }}">
         <div class="form-group col-12 floating-label-form-group controls">
             <div class="card text-center">
                 ...
                 <div class="card-body">
                     <div class="d-flex flex-column justify-content-center" wire:ignore wire:key="force-rerender"
                         x-data="{
                             setUp() {
