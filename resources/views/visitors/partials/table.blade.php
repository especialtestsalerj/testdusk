    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-sm-4 align-self-center d-flex justify-content-end">
                @if($routine->status)
                <a href="{{ route('visitors.create', $routine->id) }}" class="btn btn-primary text-white float-end" dusk="newVisitors" title="Novo/a Visitante">
            ...
            @forelse ($visitors as $visitor)
                <tr>
                    ...
                    <td class="text-center actions">
                        <a href="{{ route('visitors.show', ['id' => $visitor->id, 'disabled' => true]) }}" class="btn btn-link" title="Detalhar"><i class="fa fa-search"></i></a>
                        @if($routine->status)
                            <a href="{{ route('visitors.show', ['id' => $visitor->id]) }}" class="btn btn-link" title="Alterar"><i class="fa fa-pencil"></i></a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form" action="{{ route('visitors.delete', ['id' => $visitor->id]) }}" method="post">
                                        @csrf
