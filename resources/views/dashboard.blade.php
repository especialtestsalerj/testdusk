                ...
                <div class="row d-flex justify-content-center mb-5">
                    <div class="col-12 col-lg-8">
                        <div class="row g-0 g-lg-3 text-uppercase mt-3 d-flex justify-content-center">
                            ...
                            @include('partials.dashboard-button', ['url' => route('reservations.dashboard'), 'permission' => make_ability_name_with_current_building('visitors:show'), 'title' => 'Agendamentos', 'ico' => 'fa-calendar-days', ])
                        </div>
                    </div>
                </div>
            </div>
