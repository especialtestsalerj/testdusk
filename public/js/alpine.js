...
__webpack_require__(/*! ./vmasker */ "./resources/js/alpine/vmasker.js");
...
__webpack_require__(/*! ../support/swal */ "./resources/js/support/swal.js");
__webpack_require__(/*! ../listeners/modal */ "./resources/js/listeners/modal.js");

/***/ }),

/***/ "./resources/js/alpine/vmasker.js":
/*!****************************************!*\
  !*** ./resources/js/alpine/vmasker.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/listeners/modal.js":
/*!*****************************************!*\
  !*** ./resources/js/listeners/modal.js ***!
  \*****************************************/
/***/ (() => {
...
window.addEventListener('swal-checkout-failure', function (e) {
  Swal.fire({
    ...
    html: '<div class="row">' + '<div class="d-flex justify-content-center">' + '<h3>' + e.detail.error + '</h3>' + '</div>' + '</div>'
  });
});
window.addEventListener('swal-checkout-success', function (e) {
  Swal.fire({
    ...
    html: '<div class="row">' + '<div class="d-flex justify-content-center">' + '<h3>Checkout realizado</h3>' + '</div>' + '</div>' + '<hr class="my-1"/>' + '<div class="row">' + '<div class="col-4">' + '<img class="w-100" src="' + e.detail.photo + '">' + '</div>' + '<div class="col-8 d-flex">' + '<div class="align-self-center">' + e.detail.name + '</div>' + '</div>' + '</div>'
  });
});
...
/*!********************************!*\
  ...
  \********************************/
__webpack_require__(/*! ./alpine/alpine */ "./resources/js/alpine/alpine.js");
})();
