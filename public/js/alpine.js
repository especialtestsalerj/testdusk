...
${expression ? 'Expression: "' + expression + '"\n\n' : ''}`,
  ...
  \****************************************/
            /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                'use strict'
                __webpack_require__.r(__webpack_exports__)
                /* harmony import */ var vanilla_masker__WEBPACK_IMPORTED_MODULE_0__ =
                    __webpack_require__(
                        /*! vanilla-masker */ './node_modules/vanilla-masker/lib/vanilla-masker.js',
                    )
                /* harmony import */ var vanilla_masker__WEBPACK_IMPORTED_MODULE_0___default =
                    /*#__PURE__*/ __webpack_require__.n(vanilla_masker__WEBPACK_IMPORTED_MODULE_0__)
                /* harmony import */ var alpinejs__WEBPACK_IMPORTED_MODULE_1__ =
                    __webpack_require__(
                ...
                window.inputHandler = function (masks, max, event) {
                    ...
                    c.value = vanilla_masker__WEBPACK_IMPORTED_MODULE_0___default().toPattern(
                        v,
                        masks[m],
                    )
                }
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            Swal.fire({
                                ...
                                icon: 'success',
                                title:
                                    (options.action === 'delete' ? 'Apagado' : 'Salvo') +
                                    ' com sucesso',
                            })
                        }
                    })
