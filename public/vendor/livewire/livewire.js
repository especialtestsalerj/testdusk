!(function (global, factory) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        ? define(factory)
        : ((global = 'undefined' != typeof globalThis ? globalThis : global || self).Livewire =
              factory())
})(this, function () {
    'use strict'
     ...
     */ var isobject = function (val) {
        ...
        getValue = function (target, path, options) {
            if ((isobject(options) || (options = { default: options }), !isValidObject(target)))
    ...
    var _default$6 = (function () {
        ...
        _default$5 = (function (_Action) {
            ...
            function _default(event, params, el) {
                ...
                return (
                    ...
                    (_this.payload = { id: _this.signature, event: event, params: params }),
                    _this
                )
            }
            return (
        ...
        store$2 = {
            ...
            emitUp: function (el, event) {
                ...
                this.componentsListeningForEventThatAreTreeAncestors(el, event).forEach(function (
                    component,
                ) {
                    return component.addAction(new _default$5(event, params))
                })
        ...
        DOM = {
            ...
            setInputValue: function (el, value) {
                if (
                    (store$2.callHook('interceptWireModelSetValue', value, el), 'radio' === el.type)
                )
    ...
    var check = function (it) {
        ...
        f$5 = descriptors
            ...
            : function (O, P, Attributes) {
                  if ((anObject(O), (P = toPrimitive(P, !0)), anObject(Attributes), ie8DomDefine))
                      try {
    ...
    var inspectSource = sharedStore.inspectSource,
        ...
        nativeWeakMap =
            'function' == typeof WeakMap$1 && /native code/.test(inspectSource(WeakMap$1)),
    ...
    var internalState = { set: set$1, get: get, has: has, enforce: enforce, getterFor: getterFor },
        ...
        version
    v8
        ? ((match = v8.split('.')), (version = match[0] < 4 ? 1 : match[0] + match[1]))
        : engineUserAgent &&
          ((match = engineUserAgent.match(/Edge\/(\d+)/)),
          (!match || match[1] >= 74) &&
              ((match = engineUserAgent.match(/Chrome\/(\d+)/)), match && (version = match[1])))
        ...
        classof = toStringTagSupport
            ...
            : function (it) {
                  ...
                  return void 0 === it
                      ...
                      : null === it
                      ? 'Null'
                      : 'string' == typeof (tag = tryGet((O = Object(it)), TO_STRING_TAG$1))
                      ? tag
                      : CORRECT_ARGUMENTS
                      ? classofRaw(O)
    ...
    _export({ target: 'Array', stat: !0, forced: INCORRECT_ITERATION$1 }, { from: arrayFrom }),
        path.Array.from
    ...
    var Result = function (stopped, result) {
        ...
        $AggregateError = function (errors, message) {
            ...
            objectSetPrototypeOf &&
                ...
                void 0 !== message && createNonEnumerableProperty(that, 'message', String(message))
            var errorsArray = []
            return (
    ...
    queueMicrotask ||
        ...
        engineIsIos || engineIsNode || engineIsWebosWebkit || !MutationObserver || !document$2
    ...
    _export({ global: !0, wrap: !0, forced: FORCED }, { Promise: PromiseConstructor }),
    ...
    if (
        ...
        nativePromiseConstructor.prototype.finally !== method &&
            redefine(nativePromiseConstructor.prototype, 'finally', method, { unsafe: !0 })
    }
    var domIterables = {
            CSSRuleList: 0,
    ...
    var MATCH$1 = wellKnownSymbol('match'),
        isRegexp = function (it) {
            ...
            return (
                isObject(it) &&
                (void 0 !== (isRegExp = it[MATCH$1]) ? !!isRegExp : 'RegExp' == classofRaw(it))
            )
        },
    ...
    function fetch$1(input, init) {
        return new Promise(function (resolve, reject) {
            ...
            ;(xhr.onload = function () {
                ...
                !init || 'object' != typeof init.headers || init.headers instanceof Headers
                    ...
                    },
                    {
                        ...
                        value: function (html) {
                            ...
                            void 0 !== modal && null != modal
                                ? (modal.innerHTML = '')
                                : (((modal = document.createElement('div')).id = 'livewire-error'),
        ...
        _default$4 = (function (_Action) {
            ...
            function _default(method, params, el) {
                ...
                return (
                    ...
                    (_this.method = method),
                    (_this.payload = { id: _this.signature, method: method, params: params }),
                    _this
                )
            }
            return _default
            ...
            if (!1 !== node.isConnected) {
                ...
                if (!directives.missing('poll')) {
                    ...
                    ;(store$2.livewireIsInBackground &&
                        ...
                        Math.random() < 0.95) ||
                        (directive.modifiers.includes('visible') && !inViewport(directive.el)) ||
                ...
                (attrName = (attr = attrs[i]).name),
                    ...
                    attrNamespaceURI
                        ? ((attrName = attr.localName || attrName),
                          fromNode.getAttributeNS(attrNamespaceURI, attrName) !== attrValue &&
            ...
            for (i = (attrs = fromNode.attributes).length - 1; i >= 0; --i)
                !1 !== (attr = attrs[i]).specified &&
                    ...
                    (attrNamespaceURI = attr.namespaceURI)
                        ...
                        : toNode.hasAttribute(attrName) || fromNode.removeAttribute(attrName))
        }
    }
        ...
        return function (fromNode, toNode, options) {
            ...
            function morphEl(fromEl, toEl, childrenOnly) {
                ...
                if ((toElKey && delete fromNodesLookup[toElKey], !childrenOnly)) {
                    ...
                    if (
                        (fromEl.skipElUpdatingButStillUpdateChildren || morphAttrs(fromEl, toEl),
                ...
                'TEXTAREA' !== fromEl.nodeName
                    ...
                    : fromEl.innerHTML != toEl.innerHTML && specialElHandlers.TEXTAREA(fromEl, toEl)
            }
    ...
    var morphdom = morphdomFactory(morphAttrs),
        ...
        nodeInitializer = {
            ...
            attachModelListener: function (el, directive, component) {
                ...
                if (
                    (store$2.callHook('interceptWireModelAttachListener', directive, el, component),
                    'input' !== el.tagName.toLowerCase() || 'file' !== el.type)
                ) {
                    var condition,
                        callback,
                        ...
                        event =
                            ...
                            directive.modifiers.includes('lazy')
                                ...
                                : 'input',
                        handler =
                            ((condition = hasDebounceModifier || (DOM.isTextInput(el) && !isLazy)),
                            (callback = function (e) {
                                var _e$detail,
                    ...
                    case 'keyup':
                        this.attachListener(el, directive, component, function (e) {
                            ...
                            var modifiers = directive.modifiers.filter(function (modifier) {
                                return (
                                    !modifier.match(/^debounce$/) && !modifier.match(/^[0-9]+m?s$/)
                                )
                            })
                            return Boolean(
                                0 === modifiers.length ||
    ...
    function removeLoadingEl(component, el) {
        component.genericLoadingEls.forEach(function (element, index) {
            ...
            Object.keys(component.targetedLoadingElsByAction).forEach(function (key) {
                component.targetedLoadingElsByAction[key] = component.targetedLoadingElsByAction[
                    key
    ...
    function getDisplayProperty(directive) {
        return (
            ['inline', 'block', 'table', 'flex', 'grid', 'inline-flex'].filter(function (i) {
    ...
    function SupportAlpine() {
        window.addEventListener('livewire:load', function () {
            window.Alpine &&
                (refreshAlpineAfterEveryLivewireRequest(), addDollarSignWire(), supportEntangle())
        })
    }
    function refreshAlpineAfterEveryLivewireRequest() {
        isV3()
            ? store$2.registerHook('message.processed', function (message, livewireComponent) {
        ...
        LivewireStateManager.clearState(),
            ...
            window.addEventListener('popstate', function (event) {
                LivewireStateManager.missingState(event) ||
                    LivewireStateManager.replayResponses(event, function (response, component) {
    ...
    var LivewireStateManager = {
            ...
            updateState: function (method, url, response, component) {
                ...
                store$2.callHook(
                    'before' + ((subject = method).charAt(0).toUpperCase() + subject.slice(1)),
                    fullstateObject,
                    url,
                    component,
                )
