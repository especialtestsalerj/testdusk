...
//                'updated_by_id' => ,
                ...
                'person->social_name' => $data['socialName'],
                'person->document_type_id' => $data['documentType'],
                'person->document_number' => $data['documentNumber'],
                'person->country_id' => $data['country_id'],
                'person->state_id' => $data['state_id'],
                'person->city_id' => $data['city_id'],
                'person->email' => $data['email'],
                'person->mobile' => $data['contact'],
                'person->has_disability' => $data['hasDisability'],
                'person->birthdate' => Carbon::createFromFormat('dmY', $data['birthdate'])->format('Y-m-d'),

                'motive' => $data['motive'],
                'capacity_id' => $data['capacity']->id,
                'quantity' => 1,
